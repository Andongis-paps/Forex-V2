  ...
  $.extend(Datepicker.prototype, {
    ...
    _generateMonthYearHeader: function(a, b, c, d, e, f, g, h) {
      var i = this._get(a, "changeMonth"),
        ...
        l = '<div class="ui-datepicker-title justify-content-center row">',
        m = "";
      if (f || !i) m += '<span class="ui-datepicker-month form-select">' + g[b] + "</span>";
      else {
        var n = d && d.getFullYear() == c,
          o = e && e.getFullYear() == c;
        m +=
          '<select class="ui-datepicker-month form-select" onchange="DP_jQuery_' +
          dpuuid +
      ...
      if (!a.yearshtml) {
        a.yearshtml = "";
        if (f || !j) l += '<span class="ui-datepicker-year form-select">' + c + "</span>";
        else {
          ...
          (t = d ? Math.max(t, d.getFullYear()) : t),
            ...
            (a.yearshtml +=
              '<select class="ui-datepicker-year form-select" onchange="DP_jQuery_' +
              dpuuid +
              ".datepicker._selectMonthYear('#" +
              a.id +
              "', this, 'Y');\" " +
