...
<div class="modal fade" id="del-denom-security-code-modal" tabindex="-1" aria-labelledby="buying-transact" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row px-2">
                    ...
                    <div class="col-12 mb-3">
                        <input class="form-control password" id="del-denom-security-code" type="password">
                    </div>
                </div>
            </div>
