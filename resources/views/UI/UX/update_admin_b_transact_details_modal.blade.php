...
<div class="modal fade" id="update-admin-b-trans-sec-code-modal" tabindex="-1" aria-labelledby="buying-transact" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row px-2">
                    ...
                    <div class="col-12 mb-3">
                        <input class="form-control password" id="update-admin-b-trans-security-code" name="security-code" type="password">
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        $('#update-admin-b-trans-sec-code-modal').on('shown.bs.modal', function () {
            $('#update-admin-b-trans-security-code').focus();
        });
    });
</script>
