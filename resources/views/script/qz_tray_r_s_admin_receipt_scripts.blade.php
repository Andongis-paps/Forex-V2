...
<script>
    ...
    $(document).ready(function() {
        ...
        var forex_ascid = $('#forex-ascid').val();
        var forex_sold_serials_full_url = forex_sold_serials_base_url + '/' + forex_ascid;
            ...
            success: function(get_user_info) {
                ...
                if (sec_code_array.includes(on_page_final_printing)) {
                    ...
                    Swal.fire({
                        ...
                        $.ajax({
                            url: "{{ route('admin_transactions.admin_s_transaction.print') }}",
                            type: "post",
                            data: {
                                _token: "{{ csrf_token() }}",
    ...
    function sellingTransactReceipt() {
        ...
        var selling_trans_html =
                        ...
                        '<td style="margin-left: 10pt; padding: 0; width: 285pt;">' +
                            '<table cellspacing="0" style="font-size:9pt; font-face:\'Arial\'; padding: 0;">' +
                                '<tbody>' +
                                    ...
                                    '</tr>' +
                                    '<tr>' +
                                        '<td style="text-align: left; padding: 0;">Rate Used</td>' +
            ...
            var new_var =
                '<table>'+
                    '<tr>'+
                        '<td style="margin-left: 35pt; padding: 0; width: width: 285pt;">'+
                            '<table cellspacing="0" style="font-size:9pt; font-face:\'Arial\'; padding: 0;">' +
                                '<tbody>'+
                                    '<tr >'+
                        ...
                        '<td style="margin-left: 35pt; padding: 0; width: 285pt;">' +
                            '<table cellspacing="0" style="font-size:9pt; font-face:\'Arial\'; padding: 0;">' +
                                '<tbody>' +
                                    ...
                                    '</tr>' +
                                    '<tr>' +
                                        '<td style="padding: 0; text-align: left; font-size:7pt;" colspan="2">I hereby confirm that I have received and acknowledged the full amount exchanged in <u>'+ s_trans_currency +'</u>.</td>' +
                                    '</tr>' +
                                    '<tr>' +
                                        '<td style="text-align: right; padding: 0;"></td>' +
                                        '<td style="padding: 0;">&nbsp;</td>' +
                                    '</tr>' +
                                    '<tr>' +
                                        '<td style="padding: 0; text-align: center; border-bottom: 1px solid #000; font-size: 8pt;" colspan="2"></td>' +
