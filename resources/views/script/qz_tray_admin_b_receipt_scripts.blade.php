            ...
            success: function(get_user_info) {
                ...
                if (sec_code_array.includes(on_page_final_printing)) {
                    ...
                    Swal.fire({
                        ...
                        $.ajax({
                            url: "{{ route('admin_transactions.admin_b_transaction.print') }}",
                            type: "post",
                            data: {
                                _token: "{{ csrf_token() }}",
                    ...
                    '<tr>' +
                        '<td style="margin-left: 10pt; padding: 0; width: 285pt;">' +
                            '<table cellspacing="0" style="font-size:9pt; font-face:\'Arial\'; padding: 0;">' +
                                '<tbody>' +
                                    // '<tr>' +
                                    //     '<td style="font-size:9pt; text-align: right; padding: 0;"><b>Branch Copy</b></td>' +
                                    ...
                                    '<tr style="margin-top: 2pt;">' +
                                        '<td style="text-align: left; padding: 0; width: 100pt;">Transaction No.</td>' +
                                    ...
                                    merged_bills.forEach(function(gar) {
                                        ...
                                        new_var +=
                                            '<tr>'+
                                                ...
                                                '<td style="padding: 0; text-align: right;">' + gar.bill_rate + '&nbsp; &nbsp;&nbsp;</td>'+
                        ...
                        '<td style="margin-left: 35pt; padding: 0; width: 285pt;">' +
                            '<table cellspacing="0" style="font-size:9pt; font-face:\'Arial\'; padding: 0;">' +
                                '<tbody>' +
                                    ...
                                    '</tr>' +
                                    '<tr>' +
                                        '<td style="padding: 0; text-align: left; font-size:7pt;" colspan="2">I hereby confirm that I have received and acknowledged the full amount exchanged in <u>'+ b_trans_currency +'</u>.</td>' +
                                    '</tr>' +
                                    '<tr>' +
                                        '<td style="text-align: right; padding: 0;"></td>' +
                                        '<td style="padding: 0;">&nbsp;</td>' +
