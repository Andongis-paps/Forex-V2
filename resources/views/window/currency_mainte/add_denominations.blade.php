                        ...
                        <div class="row justify-content-center">
                            ...
                            <form class="m-0" action="{{ route('maintenance.currency_maintenance.update_denom') }}" method="post" id="denomination-form">
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="col-12 mt-2 mb-3">
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-8">
                                                                    ...
                                                                    <input type="hidden" value="{{ Str::title($result['currency']->CurrencyID) }}" name="currency">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12 mb-3">
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-7">
                                                                    <select class="form-control" name="transact-type" id="transact-type">
                                                        ...
                                                        <div class="col-12 mb-3">
                                                            <div class="row px-3">
                                                                <button class="btn btn-primary button-add-denom-new-curr" id="button-add-denom-new-curr" type="button" disabled>Add Denom &nbsp; <i class="bx bx-plus"></i></button>
                                                            </div>
                                                        </div>

                                                        <div class="col-12">
                                                            <table class="table table-hover table-bordered" id="currency-denomination-table">
                                                                <thead>
                                                                    <tr>
                                                                ...
                                                                <tbody id="curr-denom-table-new-denom-container-new-curr">
                                                                    <tr>
                                            ...
                                            <div class="col-span-12 p-2 border border-gray-300 rounded-bl rounded-br">
                                                <div class="row">
                                                    <div class="col-lg-6 offset-6 text-end">
                                                        ...
                                                        <button class="btn btn-primary btn-sm" type="button" id="save-denominations-new-curr" disabled>{{ trans('labels.confirm_action') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal fade" id="add-denom-new-curr-modal" tabindex="-1" aria-labelledby="buying-transact" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                <div class="modal-header px-4">
                                                    <h4 class="modal-title" id="buying-transact">{{ trans('labels.w_currency_save_denom') }}</h4>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="row px-2">
                                                        ...
                                                        <div class="col-12 mb-3">
                                                            <input class="form-control password" id="security-code" name="security-code">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ trans('labels.cancel_action') }}</button>
                                                    <button type="button" class="btn btn-primary" id="add-denom-new-curr-button">{{ trans('labels.proceed_action') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
