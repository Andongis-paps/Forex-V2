            ...
            <div class="container-fluid flex-grow-1 container-p-y m-0 pt-0">
                <div class="row">
                    <div class="col-lg-12 mb-4">
                        <div class="row">
                            <div class="col-12">
                                <input type="hidden" id="full-url-serials" value="{{ URL::to('/').'/'.'adminBTransactDeets' }}">
                                ...
                                <div class="card">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-6 text-end">
                                                ...
                                                @can('edit-permission', $menu_id)
                                                    <button class="btn btn-primary btn-sm btn-edit-details" id="update-admin-b-transact-details" type="button">
                                    ...
                                    @if (count($result['transact_details']) > 0)
                                        @foreach ($result['transact_details'] as $trans_deets)
                                            <form class="m-0" method="post" id="update-admin-buying-trans-details">
                                                @csrf
                                                <div class="col-12 py-2 px-1 border border-gray-300" id="buying-container">
                                                    ...
                                                    {{-- Buying Transaction - Customer Details --}}
                                                        ...
                                                        <div class="row align-items-center px-3 mt-2" id="customer-details-cont">
                                                            ...
                                                            <div class="col-9">
                                                                ...
                                                                <input type="hidden" class="form-control" name="transact-customer-id" value="{{ $trans_deets->CustomerID }}">
                                                            </div>
                                                        </div>
                                                    {{-- Buying Transaction - Customer Details --}}
                                                    ...
                                                    <div class="row align-items-center px-3 mt-2">
                                                        ...
                                                        <div class="col-9">
                                                            <textarea class="form-control" id="transact-remarks" name="transact-remarks" @if ($trans_deets->Remarks == null) rows="1" placeholder="N/A" @else rows="3" @endif readonly>{{ $trans_deets->Remarks }}</textarea>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-6">
                                <div class="card">
                                    <div class="col-12 p-2 border border-gray-300 rounded-tl rounded-tr serials-header">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                            ...
                                            <div class="col-6 text-end">
                                                @can('access-permission', $menu_id)
                                                    <a class="btn btn-primary text-white btn-sm" href="{{ route('admin_transactions.buying_transaction') }}">
                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            @forelse ($result['forex_serials'] as $forex_serials)
                                                <div id="transaction-details">
                                                    <tr class="transact-details-list-table" id="transact-details-list-table">
                                                        ...
                                                        <input type="hidden" name="forex-ftdid" value="{{ $forex_serials->AFTDID }}">
                                                    </tr>
                                                </div>
                                            @empty
                                                <tr>
                                            ...
                                            @if (count($result['forex_serials']) > 0)
                                                ...
                                                <input type="hidden" id="forex-url" data-forexurl="{{ route('admin_transactions.admin_b_transaction.details', ['id' => $forex_serials->AFTDID]) }}">
                                            @endif
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                    ...
                                    <div class="col-12 border border-gray-300 rounded-bl rounded-br p-2">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 text-end ps-0">
                                                <a class="btn btn-primary text-white btn-sm" type="button" @if (count($result['forex_serials']) > 0) href="{{ route('admin_transactions.admin_b_transaction.serials', ['id' => $forex_serials->AFTDID]) }}" @else disabled @endif>
...
@section('admin_buying_scripts')
    ...
    @include('script.qz_tray_admin_b_receipt_scripts')
@endsection
