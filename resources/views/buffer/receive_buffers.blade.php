                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="flush-receive-transf-search" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordion-receive-transfer-advance-search">
                                                        <div class="accordion-body" style="display: block;">
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="row text-center">
                                                                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic radio toggle button group">
                                                                            <input type="radio" class="btn-check" name="radio-search-type" id="currency" value="1" checked>
                                                                            <label class="btn btn-outline-primary" for="currency">
                                                                                <strong>Transaction Type</strong>
                                                                            </label>

                                                                            <input type="radio" class="btn-check" name="radio-search-type" id="transf-no" value="2">
                                                            ...
                                                            <div class="row align-items-center justify-content-center px-3" id="search-by-trans-type">
                                                                <div class="col-4 text-center">
                                                                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic radio toggle button group">
                                                                        <input type="radio" class="btn-check" name="radio-receive-transfer-type" id="transf-type-regular" value="1" checked>
                                                                        <label class="btn btn-outline-primary" for="transf-type-buffer">
                                                            ...
                                                            <div class="row align-items-center justify-content-center px-3 mb-3 d-none" id="search-by-transfer-no">
                                                                <div class="col-4">
                                                                ...
                                                                <div class="col-1 text-center">
                                                                    <div class="row">
                                                                        @can('add-permission', $menu_id)
                                                                            <button class="btn btn-primary btn-sm" id="search-buffer-transf" type="button">
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th class="text-center text-xs font-extrabold text-black p-1">
                                                            <input class="form-check-input" type="checkbox" id="transfer-forex-select-all" name="transfer-forex-select-all" disabled>
                                                        </th>
                                                        ...
                                                        <th class="text-center text-xs font-extrabold text-black p-1">Total Amount</th>
                                                    </tr>
                                                </thead>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-5 text-end">
                                                    @can('access-permission', $menu_id)
                                                        <a class="btn btn-secondary btn-sm" type="button" href="{{ route('admin_transactions.buffer.buffer_transfers') }}">{{ trans('labels.back_action') }}</a>
                                                    @endcan

                                                    @can('add-permission', $menu_id)
                                                        <button class="btn btn-primary btn-sm receive-buffer-btn" id="receive-buffer-btn" type="button" disabled>
                                                            Proceed
                                                        </button>
                                                    @endcan
                                                </div>
...
@section('receive_transf_fx_scripts')
    @include('script.receive_buff_transfers')
@endsection
