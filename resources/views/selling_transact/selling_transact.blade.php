   ...
   <div class="layout-page">
        <div class="content-wrapper">
            ...
            <div class="container-fluid flex-grow-1 container-p-y m-0 pt-0">
                <div class="row">
                    <div class="col-12">
                        @if(session()->has('message') && session()->has('latest_scid'))
                            <div class="alert alert-success alert-dismissible" role="alert" id="selling-message-saving-success" data-successexistence="1" data-recentscid="{{ session()->get('latest_scid') }}">
                                {{ session()->get('message') }}
                                    ...
                                    <div class="card">
                                        <div class="col-12 p-2 border border-gray-300 rounded-tl rounded-tr">
                                            <span class="text-lg font-bold p-2 text-black">
                                                <i class='bx bx-list-ul' ></i>&nbsp;{{ trans('labels.new_selling_trans_title') }}
                                            </span>
                                        </div>
                                            ...
                                            <div class="row align-items-center px-3 mt-3">
                                                ...
                                                <div class="col-9">
                                                    <select class="form-control" name="currencies-selling" id="currencies-select-selling" disabled>
                                                        <option id="currencies-selling-default-val" value="Select a currency">Select a currency</option>
    ...
    <div class="modal fade" id="serial-stock-modal-appended" tabindex="-1" aria-hidden="true" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content serial-stock-appended">
                @include('selling_transact.serial_stock_modal_appended')
            </div>
        </div>
    </div>
...
@section('selling_scripts')
    @include('script.selling_transact_scripts')
@endsection
